...
# from tensorflow.compat.v1 import slim
...
class DeepIRTModel(object):
    ...
    def _influence(self):
        ...
        for i in range(self.args.seq_len):
            ...
            self.summary_vector = _layers.fully_connected(
            ...
            student_ability = _layers.fully_connected(
            ...
            question_difficulty = _layers.fully_connected(
                inputs=q,
                num_outputs=1,
            ...
            # Prediction
            pred_z_value = 6.0 * student_ability - question_difficulty
    ...
    def _create_loss(self):
        ...
        filtered_logits = tf.math.log(clipped_filtered_pred/(1-clipped_filtered_pred))
